      ...
      <Scrollbar className="details-scrollbar flex-grow">
        <div className="flex flex-col p-30px pt-0">
          ...
          <div className="flex flex-col items-start">
            <span className="font-semibold text-gray-900 text-16px mb-1">
              {state.item.name}
            </span>
          ...
          <div className="flex w-full flex-col">
            <div className="flex flex-col justify-start full mt-7 pr-30px even:pr-0">
              <span className="text-gray-500 text-11px mb-1">Quantity</span>
            ...
            <div className="flex flex-col justify-start full mt-7 pr-30px even:pr-0">
              <span className="text-gray-500 text-11px mb-1">Description</span>
              <span className="font-normal text-13px text-gray-900 capitalize">
            ...
            <div className="flex flex-col justify-start full mt-7 pr-30px even:pr-0">
              <span className="text-gray-500 text-11px mb-1">Category</span>
              <span className="font-normal text-13px text-gray-900 capitalize">
                {state.item.type}
              </span>
            </div>
